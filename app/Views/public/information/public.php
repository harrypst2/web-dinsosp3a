			...
			<div class="col-12">
				<div class="text-center subcribe-form">
					<form style="max-width: 800px;">
						<input type="text" id="s" name="s" class="rounded-pill shadow" placeholder="Cari informasi publik..." value="<?= $keywords ?>">
			...
			<?php if (count($articles) <= 0) : ?>
				<div class="col-12 text-center mt-4 pt-2">
					...
					<p class="text-muted para-desc mx-auto">
						Informasi yang kamu cari tidak dapat ditemukan.
					</p>
				</div>
			<?php else : ?>
				<?php foreach ($articles as $article) : ?>
					<div class="col-lg-4 col-md-6 col-12 mt-4 pt-2 picture-item">
						<div class="card blog border-0 work-container work-classic shadow rounded-md overflow-hidden">
							...
							<div class="card-body">
								<div class="content">
									<h5 class="mb-3"><a href="<?= base_url("public/" . $article->slug) ?>" class="text-dark title"><?= $article->title ?></a></h5>
									<a href="<?= base_url("public/" . $article->slug) ?>" class="text-primary h6">Baca <i class="uil uil-angle-right-b align-middle"></i></a>
								</div>
							</div>
						</div>
					</div>
