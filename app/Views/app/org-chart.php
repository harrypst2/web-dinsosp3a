	...
	<div class="modal-dialog modal-md modal-dialog-centered" role="document">
		...
		<div class="modal-body">
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" name="position" placeholder="Contoh: Kepala Bidang">
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
				...
				<select name="bidang" class="form-control">
					...
					<option value="Bidang Perlindungan Jaminan Sosial">Bidang Perlindungan Jaminan Sosial</option>
					...
					<option value="Bidang Pemberdayaan Perempuan dan Perlindungan Anak">Bidang Pemberdayaan Perempuan dan Perlindungan Anak</option>
				</select>
			</div>
			<div class="mb-3">
			...
			<div class="mb-0">
				...
				<select name="parent" class="form-control">
					...
					<?php foreach ($orgchart as $children) : ?>
...
<script>
	$(document).ready(function() {
		...
		$(document).on("click", ".edit-button", function() {
			...
			modal.find("select[name='bidang']").val(bidang);
