...
<?= $this->section("body") ?>
<div class="col-12">
	<?= form_open_multipart($settings->panelPrefix . "/news/update/" . $article->id, ["class" => "card"]) ?>
	<div class="card-body">
		<div class="row">
			<div class="col-md-8">
				<div class="mb-3">
				...
				<div class="mb-3">
					...
					<select name="category" class="form-select" id="categories">
						...
						<?php foreach ($categories as $category) : ?>
							<option value="<?= $category->id ?>" <?= $article->category == $category->id ? "selected" : "" ?>><?= $category->name ?></option>
						<?php endforeach ?>
					</select>
				</div>
				<div class="mb-0">
