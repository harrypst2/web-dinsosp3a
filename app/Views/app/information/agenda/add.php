...
<?= $this->section("body") ?>
<div class="col-12">
	<?= form_open_multipart($settings->panelPrefix . "/information/agenda/insert", ["class" => "card"]) ?>
	<div class="card-body">
		<div class="row">
			<div class="col-md-8">
				<div class="mb-3">
			...
			<div class="col-md-4">
				<div class="mb-3">
					...
					<div class="input-icon mb-2">
						<input type="text" name="date" class="form-control" id="datepicker" value="<?= old("date") ?: date("Y-m-d") ?>" />
