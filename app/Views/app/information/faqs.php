...
<div class="col-auto ms-auto d-print-none">
	<div class="btn-list">
		...
		<a href="javascript:void(0)" class="add-button btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal" data-bs-backdrop="static" data-bs-target="#modal-form" aria-label="Tambah FAQ">
			<?= tabler_icon("plus") ?>
		</a>
	</div>
</div>
...
<div class="modal modal-blur fade" id="modal-form" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-md modal-dialog-centered" role="document">
		<?= form_open(current_url() . "/insert", ["class" => "modal-content", "data-page" => "FAQ"]) ?>
