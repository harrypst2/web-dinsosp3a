<header class="navbar navbar-expand-md navbar-light sticky-top d-print-none">
	<div class="container-xl">
		...
		<h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
			<a href="<?= base_url($settings->panelPrefix . "/overview") ?>">
				<img src="<?= base_url("assets/images/logo.png") ?>" width="110" height="32" alt="<?= $settings->appTitle ?>" class="navbar-brand-image">
			</a>
		</h1>
		...
		<div class="navbar-nav flex-row order-md-last">
			<div class="nav-item dropdown">
				...
				<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
					<a href="<?= base_url($settings->panelPrefix . "/profile") ?>" class="dropdown-item">Profil & Akun</a>
