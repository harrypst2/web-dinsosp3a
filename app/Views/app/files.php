...
<div class="col-auto ms-auto d-print-none">
	<div class="btn-list">
		...
		<a href="javascript:void(0)" class="add-button btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal" data-bs-backdrop="static" data-bs-target="#modal-form" aria-label="Tambah Berkas">
			<?= tabler_icon("plus") ?>
		</a>
	</div>
</div>
		...
		<div class="modal-body">
			...
			<div class="mb-0">
				...
				<label class="form-check form-switch">
					<?= form_checkbox("active", "active", true, ["class" => "form-check-input"]) ?>
					<span class="form-check-label">Aktif / Tidak Aktif</span>
				</label>
			</div>
		</div>
