...
class Informations extends Migration
{
	...
	public function up()
	{
		...
		// if use timestamps, add created_at & updated_at columns
		...
		// if use soft deletes, add deleted_at column
		...
		// Alter table
		$this->db->query("ALTER TABLE $this->tableName ADD FULLTEXT (title, content)");
